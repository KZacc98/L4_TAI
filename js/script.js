...
function​ setQuestion​(index) {​ //clearClass();
...
function​ doAction​(event) {​ //event.target - Zwraca referencję do elementu, do któregozdarzenie zostało pierwotnie wysłane.
    ​
    if​ (event.​target​.​innerHTML​ === preQuestions[index].​correct_answer​) {
        points++​;​
        pointsElem.innerText = points;​
    ...
    else​ {​ markInCorrect​(event.​target)​​;​ }​
    disableAnswers​()​;
}
